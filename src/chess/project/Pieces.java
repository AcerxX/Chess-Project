...
public class Pieces {
    ...
    /**
     * Returneaza ca string posibilitatile de mutare a piesei de pe pozitia i si
     * j sub forma de string. <BR>
     *
     * POSIBILITATI:<BR>
     ...
     * - 1fata, 1diag, 1spate, 1stanga, 1dreapta => acelasi lucru ca cele de mai
     * sus, difera doar numarul de pozitii.<BR>
     * - specialRege => (REGE) poate fi mutata maxim o pozitie in toate
     * directiile<BR>
     *
     * @param i
     * @param j
    ...
    static String getValid(int i, int j) {
        ...
        switch (Pieces.type) {
            ...
            case "dama":
                return "7fata 7diag 7spate 7stanga 7dreapta";
            case "rege":
                return "specialRege";
            case "nebun":
                return "7diag";
            case "tura":
                return "7stanga 7dreapta 7fata 7spate";
            case "cal":
                return "specialL";
        }
    ...
    /**
     * Returneaza o lista cu toate miscarile (in coord xboard) posibile SI
     * LEGALE pentru o pozitie i si j.
     *
     * @return
     */
